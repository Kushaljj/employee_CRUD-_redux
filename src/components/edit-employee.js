...
class EditEmployee extends React.Component {
    ...
    handleOnSubmit = e => {
        e.preventDefault();
        this.props.dispatch(empUpdate({ id: this.props.match.params.id, name: this.name, age: this.age, salary: this.salary, department: this.department }));
    }
                ...
                <div className="col-md-9 mx-sm-auto col-lg-10 px-md-4">
                    ...
                    <form className="needs-validation" onSubmit={this.handleOnSubmit}>
                        <div className="row g-3">
                            ...
                            <div className="col-sm-6">
                                <label htmlFor="lastName" className="form-label">Salary</label>
                                <input type="number" className="form-control" id="salary" placeholder="Salary" onChange={e => this.salary = e.target.value} defaultValue={this.salary} required />
                                <div className="invalid-feedback">Valid Salary is required.</div>
                            </div>
