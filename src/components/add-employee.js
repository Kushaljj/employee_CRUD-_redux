...
class AddEmployee extends React.Component {
    ...
    employee = { name: '', age: 0, department: '', salary: 0 };
                ...
                <form className="needs-validation" noValidate onSubmit={this.handleOnSubmit}>
                    <div className="row g-3">
                        ...
                        <div className="col-sm-6">
                            ...
                            <input type="number" className="form-control" id="salary" placeholder="" onChange={e => this.employee.salary = e.target.value} required />
